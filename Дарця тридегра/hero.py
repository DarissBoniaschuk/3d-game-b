...
class Hero():
    def __init__(self,pos,land):
        self.land = land
        self.mode = True
        self.hero = loader.loadModel("minecraft_emoskin_free.glb")
    ...
    def cameraBind(self):
        ...
        self.cameraOn = 1
        crosshears =OnscreenImage(image = 'crosshairs.png', pos = (0,0,0), scale = 0.05)
        crosshears.setTransparency(TransparencyAttrib.MAlpha)
